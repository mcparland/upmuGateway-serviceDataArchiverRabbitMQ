...
${OBJECTDIR}/_ext/498f5db2/upmuDataProtobuf.pb.o: ../uPMUgateway/upmuDataProtobuf.pb.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/498f5db2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/498f5db2/upmuDataProtobuf.pb.o ../uPMUgateway/upmuDataProtobuf.pb.cc

${OBJECTDIR}/_ext/498f5db2/upmuStructKeyValueListProtobuf.pb.o: ../uPMUgateway/upmuStructKeyValueListProtobuf.pb.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/498f5db2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/498f5db2/upmuStructKeyValueListProtobuf.pb.o ../uPMUgateway/upmuStructKeyValueListProtobuf.pb.cc

${OBJECTDIR}/serviceDataArchiverRabbitMQ.o: serviceDataArchiverRabbitMQ.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/serviceDataArchiverRabbitMQ.o serviceDataArchiverRabbitMQ.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libserviceDataArchiverRabbitMQ.${CND_DLIB_EXT}
